...
- **CSS3:** Custom styling to manage object layouts perfectly.

## 📁 File Structure
```text
├── photograph.html              # Main HTML holding the portfolio structure
├── README.md                    # Project documentation
├── ram_rahman.png               # Main portrait image
├── gallery_img_1.png            # Gallery asset 
├── gallery_img_2.png            # Gallery asset
└── gallery_img_3.png            # Gallery asset
```
